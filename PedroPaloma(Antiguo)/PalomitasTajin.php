<?php
session_start();
$_SESSION["producto"] = "Palomitas de Tajin";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasTajin.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas de Tajín</h2>
          <p class="DetallesProducto">El sabor mas vendido, experimenta ese sabor agridulce con nuestras palomitas Tajín.</p>
          <h3 class="Precio">$ 20.00</h3>
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasTajin.php" method="post" onsubmit="return validador()">
            <div class="row">
