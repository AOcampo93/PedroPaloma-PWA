<?php
session_start();
$_SESSION["producto"] = "Palomitas Caseras";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasCaseras.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas Receta de Casa</h2>
          <p class="DetallesProducto">Bolsa de palomitas sazonadas con la receta de la casa, experimenta este sabor que ha enloquecido a muchos.</p>
          <h3 class="Precio">$ 16.00</h3>
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasCaseras.php" method="post" onsubmit="return validador()">
            <div class="row">
