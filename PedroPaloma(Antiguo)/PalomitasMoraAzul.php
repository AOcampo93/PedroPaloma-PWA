<?php
session_start();
$_SESSION["producto"] = "Palomitas de Mora Azul";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasMoraAzul.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas de Mora Azul</h2>
          ...
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasMoraAzul.php" method="post" onsubmit="return validador()">
            <div class="row">
