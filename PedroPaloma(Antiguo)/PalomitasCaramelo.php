<?php
session_start();
$_SESSION["producto"] = "Palomitas de Caramelo";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasCaramelo.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas de Caramelo</h2>
          <p class="DetallesProducto">Bolsa de palomitas sabor caramelo, disfruta de este clásico delicioso.</p>
          <h3 class="Precio">$ 25.00</h3>
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasCaramelo.php" method="post" onsubmit="return validador()">
            <div class="row">
