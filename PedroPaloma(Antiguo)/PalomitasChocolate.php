<?php
session_start();
$_SESSION["producto"] = "Palomitas de Chocolate";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasChocolate.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas de Chocolate</h2>
          <p class="DetallesProducto">Bolsa de palomitas con el clásico sabor a chocolate que a todos nos encanta.</p>
          <h3 class="Precio">$ 25.00</h3>
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasChocolate.php" method="post" onsubmit="return validador()">
            <div class="row">
