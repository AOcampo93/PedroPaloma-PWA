<?php
session_start();
$_SESSION["producto"] = "Palomitas de Mantequilla";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasMantequilla.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas de Mantequilla</h2>
          <p class="DetallesProducto">El clásico sabor que nunca pasa de moda, disfruta una bolsa de palomitas sabor mantequilla.</p>
          <h3 class="Precio">$ 16.00</h3>
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasMantequilla.php" method="post" onsubmit="return validador()">
            <div class="row">
