...
<html lang="en">
  <head>
    ...
    <title>PedroPaloma | Pago Exitoso</title>
  </head>
  <body>
    <!--Navbar-->
          ...
          <div class="col-12 background center">
            <div class="ContainerBox">
              <div class="col-12 wrap">
                ...
                <div class="row maxwidth center">
                  <h2 class="textCenter">¡Pago exitoso!</h2>
                </div>
                <div class="row maxwidth center">
                  <p class="CenterText text">Listo <?php echo $nombre;?> recoge tu producto: (<?php echo $producto; ?>) a las: <?php echo $horario;?> en el lugar de reparto.</p>
                </div>
                <hr>
