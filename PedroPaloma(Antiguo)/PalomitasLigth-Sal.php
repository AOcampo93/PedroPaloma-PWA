<?php
session_start();
$_SESSION["producto"] = "Palomitas Ligth con Sal";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasLigth-Sal.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas Ligth con Sal</h2>
          <p class="DetallesProducto">Bolsa de palomitas light 100% naturales acompañadas con un toque de sal.</p>
          <h3 class="Precio">$ 16.00</h3>
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasLight-Sal.php" method="post" onsubmit="return validador()">
            <div class="row">
