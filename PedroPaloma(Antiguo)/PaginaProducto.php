    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/producto.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Nombre del producto</h2>
          <p class="DetallesProducto">Detalles del producto, sabores, calorias, información nutrimental o descripción de ingredientes.</p>
          <h3 class="Precio">$ 00.00</h3>
          <!--Formulario-->
          <form class="" action="Enviador.php" method="post" onsubmit="return validador()">
            <div class="row">
