<?php
session_start();
$_SESSION["producto"] = "Palomitas de limon";
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row margin-top">
        ...
        <div class="col-12 col-md-4">
          <a href="index.html">
            <img class="img-fluid imgProducto" src="images/Producto-PalomitasLimon.png" alt="imagen de producto">
          </a>
        </div>
        <div class="col-12 col-md-4 padding-Mobile">
          <h2 class="TitulosProducto">Palomitas de Limón</h2>
          ...
          <!--Formulario-->
          <form class="" action="Enviador-PalomitasLimon.php" method="post" onsubmit="return validador()">
            <div class="row">
